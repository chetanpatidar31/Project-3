...
<!-- Birth Date -->
<span class="pl-sm-5"><b>Birth Date</b><span style="color:red">*</span></span><br>
<div class="col-sm-12">
<div class="input-group">
<div class="input-group-prepend">
<div class="input-group-text">
...
<font color="red" class="pl-sm-5">
<%=ServletUtility.getErrorMessage("birthDate", request)%>
</font><br>

<!-- Contact No -->
<span class="pl-sm-5"><b>Contact No</b><span style="color:red">*</span></span><br>
<div class="col-sm-12">
<div class="input-group">
<div class="input-group-prepend">
<div class="input-group-text">
